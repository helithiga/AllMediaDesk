...
public class Task3Graph extends JPanel {
    ...
    public Task3Graph(double[] scores) {
        this.scores = scores;
    }
...
//    }
    ...
    static void createAndShowGui(double[] data) {
        double[] scores = data;
...
////            scores.add((double) i);
//        }
        Task3Graph mainPanel = new Task3Graph(scores);
