...
public class Task3Cal {
	public ArrayList<String> BracesCal(String numberArgument) {
		...
		for (double i=0;i<=10;i+=0.5) {
			char num = (char)i;
			String replaceString=numberArgument.replace('a',num);	
		
			String yAns = calculate(numberArgument);
			yVal.add(yAns);
		}
		return yVal;
    }
